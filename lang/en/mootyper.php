...
$string['attemptdeleteonlylast'] = 'Delete blocked. You may delete only the latest completed exercise result for that user in this lesson.';
$string['attemptrecoverall'] = 'Reset stuck attempts (all users)';
$string['attemptrecovermine'] = 'Reset my stuck attempt';
$string['attemptrecoverydone'] = 'Attempt recovery completed. Closed {$a} stuck attempt(s).';
$string['attemptsubmitblockedinprogress'] = 'Submission was blocked because this attempt was not finalized yet. Please complete the exercise and click Continue again.';
$string['attemptsubmitblockedmissing'] = 'Submission was blocked because no valid attempt was found for this exercise result.';
...
$string['deleteall'] = 'Delete all exercises from ';
...
$string['deletekb'] = 'Select layout to delete';
$string['deletekblo'] = 'Delete - {$a}';
$string['deletelsnconfirm'] = 'Confirm you are about to completely delete ';
$string['dictationdatalabel'] = 'Dictation mode audio/video media';
$string['dictationdatalabelhelp'] = 'Use this only when you want students to type from recorded or embedded audio/video dictation media.';
...
$string['exercisesinthelesson'] = 'Exercises in lesson';
...
$string['flushresultsall'] = 'Flush all results';
$string['flushresultsconfirmall'] = 'Confirm you are about to flush all MooTyper results for this activity.';
$string['flushresultsconfirmfiltered'] = 'Confirm you are about to flush the currently filtered MooTyper results.';
$string['flushresultsconfirmmine'] = 'Confirm you are about to flush your MooTyper results and start this lesson over.';
$string['flushresultsdone'] = 'Flush completed. Removed {$a} grade result(s).';
$string['flushresultsfiltered'] = 'Flush filtered results';
$string['flushresultsmine'] = 'Start over (flush my results)';
$string['flushresultspracticefilteredall'] = 'Flush filtered/all Practice results';
$string['fmode'] = 'Mode';
...
$string['grade_delete_blocked'] = 'Blocked grade delete attempt';
...
$string['jumpgradesbottom'] = 'Jump to bottom of grades';
$string['jumpgradestop'] = 'Jump to top of grades';
...
$string['logfilterhintblockeddelete'] = 'Audit hint: Site administration > Reports > Logs. Set Course to this course, Component to mod_mootyper, and Event name to "Blocked grade delete attempt".';
...
$string['lsnimportfilterhelp'] = 'Choose whether to show only new or changed items, or include existing unchanged items too.';
$string['lsnimporthiddenrows'] = '{$a} existing unchanged item(s) hidden.';
$string['lsnimportloaded'] = 'Scan finished. Results are shown below.';
$string['lsnimportnotadd'] = 'Already in the database. Nothing to do.';
$string['lsnimportprocessing'] = 'Scanning lesson and keyboard layout files now.';
$string['lsnimportprocessingdetails'] = 'Checking {$a->lessons} lesson file(s) and {$a->layouts} layout file(s). On larger sites this page can take a little while to finish printing results.';
$string['lsnimportresultsframe'] = 'Import scan results';
$string['lsnimportshowall'] = 'Show all';
$string['lsnimportshowchangesonly'] = 'Show only new / changed';
$string['lsnimportstarting'] = 'Loading the import scan page now.';
$string['lsnimportstartrun'] = 'Start import scan';
...
$string['noexercisesinthelesson'] = 'No exercises found for this lesson.';
...
$string['timesubmissionrejected'] = 'Submission was not saved because the time limit was exceeded (limit: {$a->limit}s, submitted: {$a->elapsed}s).';
