/**
 * @fileOverview Amharic(V5) keyboard driver.
...
function keyboardElement(ltr) {
    ...
    if (isLetter(ltr)) { // Set specified shift key for right or left.
        ...
        // phpcs:ignore
        } else if (ltr.match(/[YUIOPHJKLMN67890_+]/)) {
            this.shiftleft = true;
        }
    }
...
function thenFinger(tCrka) {
    ...
    } else if (tCrka.match(/[`~!1|ቅQአዐዝዥ<>\\à0}pm)°^¨[ù%´=+~\-_$*\]µ£`]/i)) {
...
function getKeyID(tCrka) {
    if (tCrka === ' ') {
        ...
        return "jkey1";
    } else if (tCrka === '@' || tCrka === '2') {
        return "jkey2";
    } else if (tCrka === '#' || tCrka === '3') {
        return "jkey3";
    } else if (tCrka === '$'' || tCrka === '4') {
        return "jkey4";
    } else if (tCrka === '%' || tCrka === '5') {
        return "jkey5";
    } else if (tCrka === '^' || tCrka === '6') {
        return "jkey6";
    } else if (tCrka === '&' || tCrka === '7') {
        return "jkey7";
    } else if (tCrka === '*' || tCrka === '8') {
        return "jkey8";
    } else if (tCrka === '(' || tCrka === '9') {
        return "jkey9";
    } else if (tCrka === ')' || tCrka === '0') {
        return "jkey0";
    ...
    } else if (tCrka === 'a' || tCrka === 'አ') {
        return "jkeya";
    } else if (tCrka === 's' || tCrka === 'ስ') {
        return "jkeys";
    } else if (tCrka === 'd' || tCrka === 'ድ') {
        return "jkeyd";        
    } else if (tCrka === 'e' || tCrka === 'ፍ') {
        return "jkeya";
    } else if (tCrka === 'f' || tCrka === 'ግ') {
        return "jkeyf";
    } else if (tCrka === 'g' || tCrka === 'ህ') {
        return "jkeyg";
    } else if (tCrka === 'h' || tCrka === 'ጅ') {
        return "jkeyh";
    } else if (tCrka === 'j' || tCrka === 'ክ') {
        return "jkeyj";
    } else if (tCrka === 'k' || tCrka === 'ል') {
        return "jkeyk";
    } else if (tCrka === 'l || tCrka === '፤') {
        return "jkeyl";
    } else if (tCrka === '፡' || tCrka === '፤') {
        return "jkey፤";
    } else if (tCrka === 'a' || tCrka === '\') {
        return "jkey\";
